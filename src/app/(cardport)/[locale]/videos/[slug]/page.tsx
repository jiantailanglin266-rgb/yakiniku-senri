      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_22rem]">
        <div className="space-y-8">
          ...
          <Panel className="overflow-hidden">
            {video.youtubeId ? (
              ...
              <div className="from-violet/35 via-magenta/20 to-navy grid aspect-video place-items-center bg-gradient-to-br">
                <p className="text-mist px-6 text-center text-[0.8rem]">
                  {locale === "ja"
          ...
          <section aria-labelledby="summary">
            ...
            <Panel className="p-5">
              <ul className="text-mist space-y-2 text-[0.86rem] leading-relaxed">
            ...
            <section aria-labelledby="chapters">
              ...
              <ol className="space-y-1.5">
                {video.chapters.map((chapter) => (
                  ...
                  >
                    <span className="numeric text-cyan shrink-0 text-[0.76rem]">
                      {formatDuration(chapter.at)}
                    </span>
                    <span className="text-mist text-[0.8rem]">{pick(chapter.label, locale)}</span>
                  </li>
                ))}
              </ol>
            </section>
          ...
          <section aria-labelledby="transcript">
            ...
            <Panel className="p-5">
              <ul className="text-mist space-y-2 text-[0.84rem] leading-relaxed">
        ...
        <aside className="space-y-5 lg:sticky lg:top-24 lg:self-start">
          <Panel glow className="p-5">
            <h2 className="text-ink mb-3 text-[0.88rem] font-semibold">
            ...
            {channels.youtube ? (
              <a
                ...
                className="text-magenta mt-4 inline-block text-[0.78rem] hover:underline"
              >

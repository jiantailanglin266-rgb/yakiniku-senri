      ...
      <div className="grid gap-10 lg:grid-cols-[1fr_20rem]">
        <article className="max-w-3xl">
          {pickList(article.body, locale).map((paragraph) => (
            <p key={paragraph} className="text-mist mb-5 text-[0.9rem] leading-[1.95]">
              {paragraph}
            </p>
          ))}

          <div className="border-line/50 mt-8 border-t pt-5">
            <p className="text-dim text-[0.76rem]">
        ...
        <aside className="space-y-5">
          ...
          {relatedCards.length > 0 ? (
            <div>
              <h2 className="text-ink mb-3 text-[0.84rem] font-semibold">

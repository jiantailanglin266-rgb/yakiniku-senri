            ...
            return (
              <li key={service.id}>
                <Panel className="h-full p-4">
                  <h3 className="text-cp-ink text-[0.88rem] font-semibold">
                    {pick(service.name, locale)}
                  </h3>
                  <p className="text-cp-dim mt-2 text-[0.72rem]">
                    {locale === "ja" ? "チャージ元" : "Top-up sources"}
                  </p>
                  <ul className="text-cp-mist mt-1 space-y-0.5 text-[0.74rem]">
                        ...
                        {best.map((card) => (
                          <li key={card.id}>
                            <Link
                              ...
                              className="text-cp-cyan text-[0.76rem] hover:underline"
                            >

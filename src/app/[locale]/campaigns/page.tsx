            ...
            <li key={campaign.id}>
              <Panel as="article" className="h-full p-5">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {campaign.maxValue > 0 ? (
                    <span className="numeric text-cp-amber text-[0.86rem] font-semibold">
                      {dictionary.card.upTo} {formatYen(campaign.maxValue, locale)}
                    </span>
                  ) : null}
                </div>

                <h2 className="text-cp-ink mt-3 text-[0.98rem] leading-snug font-semibold">

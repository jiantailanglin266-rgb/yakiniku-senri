      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_20rem]">
        <div className="space-y-8">
          ...
          <section aria-labelledby="pros" className="grid gap-4 sm:grid-cols-2">
            <Panel className="p-5">
              <h2 id="pros" className="text-cp-emerald mb-3 text-[0.95rem] font-semibold">
            ...
            <Panel className="border-cp-danger/30 p-5">
          ...
          <a
            ...
            className="glass text-cp-ink hover:border-cp-magenta/60 inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-[0.82rem] transition-colors"
          >
        ...
        <aside className="space-y-5">
                ...
                {relatedVideos.map((video) => (
                  <li key={video.id}>
                    <Link
                      ...
                      className="text-cp-mist hover:text-cp-magenta text-[0.78rem]"
                    >
          ...
          <Panel className="p-4">
            ...
            <Link
              ...
              className="text-cp-cyan text-[0.78rem] hover:underline"
            >
